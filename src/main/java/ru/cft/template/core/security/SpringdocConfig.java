...
public class SpringdocConfig {
    ...
    private final String DOC_TITLE = "Документация по кошельку";
    private final String DOC_VERSION = "2.0.0";
    private final String DOC_DESCRIPTION = "Данный кошелек - это отечественный электронный кошелек, который " +
            "предоставляет возможность оплаты услуг и осуществления денежных переводов в рамках своей системы." +
            " В данном документе содержится описание основной логики взаимодействия с системой, включая создание пользователя," +
